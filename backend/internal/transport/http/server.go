...
func NewServer(cfg *config.Config, svc *service.Service, jwt *auth.JWTManager, authUC *auth.AuthUseCase) *Server {
	...
	router.Use(CORSMiddleware(cfg.FrontendOrigins))
	...
	protected.Use(AuthMiddleware(jwt))
	{
		...
		protected.POST("/games/:gameId/participants/me/accept", gameHandler.AcceptGameParticipation)
		protected.POST("/games/:gameId/participants/me/decline", gameHandler.DeclineGameParticipation)
		protected.POST("/games/:gameId/participants/:playerId/confirm", gameHandler.ConfirmGameParticipation)
		...
		protected.POST("/games/:gameId/participants/:playerId/rebuy/fix", gameHandler.FixRebuy)
		protected.POST("/games/:gameId/participants/:playerId/chips", gameHandler.SetChipsEnd)
		protected.POST("/games/:gameId/participants/me/stack", gameHandler.SetCurrentStack)
